...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/parent_login.css">
</head>
<body>
   <div class="container" id="container">
        <div class="background-image"></div>
        <div class="form-container sign-up">
            <form action="parent_login1.php" method="post">
                ...
                <input type="text" name="kid_name" placeholder="Kid's Name" required>
...
<script src="./assets/js/parent_login.js"></script>
</body>
</html>